...
import com.padcmyanmar.smtz.themovieapp.data.vos.CollectionVO
...
class CollectionTypeConverter {
    ...
    @TypeConverter
    fun toCollectionVO(commentListStr: String) : CollectionVO? {
        val collectionVOType = object : TypeToken<CollectionVO?>() {}.type
        return Gson().fromJson(commentListStr,collectionVOType)
    }
}